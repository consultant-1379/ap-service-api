...
public interface UpgradePackageSearchService {
     ...
     * @param nodeName the input data to be used to construct validate request
     * @param nodeTypeIdForPackageName the input data to be used to construct validate request
