...
import com.ericsson.oss.services.ap.api.exception.HwIdAlreadyBoundException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.InvalidNodeStateException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.NodeNotFoundException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.PartialProjectDeletionException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.ProjectNotFoundException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.UnsupportedNodeTypeException; //NOPMD
import com.ericsson.oss.services.ap.api.exception.ValidationException; //NOPMD
...
public interface AutoProvisioningService {
    ...
    /**
     * Downloads a generated CIQ file which contains the header values for each substitution tag in the files retrieved from Configuration Template
     * Service.
     *
     * @param fileName
     *            the file name
     * @param projectInfo
     *            the projectInfo.xml file
     * @return the auto-generated CIQ file
     */
    String downloadCIQ(final String fileName, final byte[] projectInfo);
    ...
    /**
     * Performs a hardware replace on the given node.
     *
     * @param nodeName
     ...
     *            node serial number
     * @throws ApServiceException
     *             if there is a general error executing the hardware replace
     */
    void hardwareReplace(final String nodeName, final String hardwareSerialNumber);
