...
/**
 * Thrown to indicate that a required MO for the hardware replace usecase does not exist.
 */
public class HardwareReplaceMoNotFoundException extends ApApplicationException {
     ...
     */
    public HardwareReplaceMoNotFoundException(final String moType, final String networkElementName) {
        this.moType = moType;
