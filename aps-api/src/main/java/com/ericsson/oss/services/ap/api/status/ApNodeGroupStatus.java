...
/**
 * The detailed status of a group of nodes, containing the comprehensive node status of each of the nodes in the collection and a brief statistics summary of
 * the group.
 */
public class ApNodeGroupStatus implements Serializable {
    ...
    /**
     * Returns a list of {@link NodeStatus} objects for each of the nodes within the node group. The nodes will be sorted alphabetically by their names.
     *
     * @return a list of NodeStatuses
     */
    public List<NodeStatus> getNodesStatus() {
        Collections.sort(nodeStatuses, new Comparator<NodeStatus>() {
    ...
    /**
     * Returns a summary of the {@link IntegrationPhase} of the nodes within the node group. Will count the nodes in each phase, and return a map of each
     * phase with the corresponding amount of nodes.
     *
    ...
    /**
     * Enum to determine the type of node collection
     * DEPLOYMENT
     * PROJECT
     */
